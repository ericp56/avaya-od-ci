...
public interface IProjectVariables {
	...
	public static final String MATH_QUIZ_CHOICE = "MathQuizChoice";
	...
	public static final String CALCULATE_ANSWER = "CalculateAnswer";
	public static final String YOUR_REPORT_CARD = "YourReportCard";
	...
	public static final String WHAT_IS = "WhatIs";
	public static final String MOD_NUM = "ModNum";
	...
	public static final String MATH_QUIZ_CHOICE_FIELD_COLUMN_1 = "Column1";
	public static final String MATH_QUIZ_CHOICE_FIELD_CONFIDENCE = "confidence";
	public static final String MATH_QUIZ_CHOICE_FIELD_INPUTMODE = "inputmode";
	public static final String MATH_QUIZ_CHOICE_FIELD_INTERPRETATION = "interpretation";
	public static final String MATH_QUIZ_CHOICE_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String MATH_QUIZ_CHOICE_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String MATH_QUIZ_CHOICE_FIELD_UTTERANCE = "utterance";
	public static final String MATH_QUIZ_CHOICE_FIELD_VALUE = "value";
	...
	public static final String CALCULATE_ANSWER_FIELD_COLUMN_1 = "Column1";
	public static final String CALCULATE_ANSWER_FIELD_CONFIDENCE = "confidence";
	public static final String CALCULATE_ANSWER_FIELD_INPUTMODE = "inputmode";
	public static final String CALCULATE_ANSWER_FIELD_INTERPRETATION = "interpretation";
	public static final String CALCULATE_ANSWER_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String CALCULATE_ANSWER_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String CALCULATE_ANSWER_FIELD_UTTERANCE = "utterance";
	public static final String CALCULATE_ANSWER_FIELD_VALUE = "value";
	...
	public static final String WHAT_IS_FIELD_COLUMN_1 = "Column1";
	public static final String WHAT_IS_FIELD_CONFIDENCE = "confidence";
	public static final String WHAT_IS_FIELD_INPUTMODE = "inputmode";
	public static final String WHAT_IS_FIELD_INTERPRETATION = "interpretation";
	public static final String WHAT_IS_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String WHAT_IS_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String WHAT_IS_FIELD_UTTERANCE = "utterance";
	public static final String WHAT_IS_FIELD_VALUE = "value";
