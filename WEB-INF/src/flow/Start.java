...
public class Start extends com.avaya.sce.runtime.Entry {
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variableFields = new String[] {
			IProjectVariables.MATH_QUIZ_CHOICE_FIELD_COLUMN_1,
			IProjectVariables.MATH_QUIZ_CHOICE_FIELD_CONFIDENCE,
			IProjectVariables.MATH_QUIZ_CHOICE_FIELD_INPUTMODE,
			IProjectVariables.MATH_QUIZ_CHOICE_FIELD_INTERPRETATION,
			IProjectVariables.MATH_QUIZ_CHOICE_FIELD_NOINPUTCOUNT,
			IProjectVariables.MATH_QUIZ_CHOICE_FIELD_NOMATCHCOUNT,
			IProjectVariables.MATH_QUIZ_CHOICE_FIELD_UTTERANCE,
			IProjectVariables.MATH_QUIZ_CHOICE_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.MATH_QUIZ_CHOICE, variableFields, null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.NUM_3, "0", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.NUM_2, "0", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.TEMP_COUNT, "0", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.NUM_1, "0", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.SCORE, "0", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.CORRECT_ANSWERS, "0", null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.CALCULATE_ANSWER_FIELD_COLUMN_1,
			IProjectVariables.CALCULATE_ANSWER_FIELD_CONFIDENCE,
			IProjectVariables.CALCULATE_ANSWER_FIELD_INPUTMODE,
			IProjectVariables.CALCULATE_ANSWER_FIELD_INTERPRETATION,
			IProjectVariables.CALCULATE_ANSWER_FIELD_NOINPUTCOUNT,
			IProjectVariables.CALCULATE_ANSWER_FIELD_NOMATCHCOUNT,
			IProjectVariables.CALCULATE_ANSWER_FIELD_UTTERANCE,
			IProjectVariables.CALCULATE_ANSWER_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.CALCULATE_ANSWER, variableFields, null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.YOUR_REPORT_CARD, "", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.TEMP, "", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.TOTAL_QUESTIONS, "0", null, session, false, false );
		session.putVariable(variable);
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.WRONG_ANSWERS, "0", null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.WHAT_IS_FIELD_COLUMN_1,
			IProjectVariables.WHAT_IS_FIELD_CONFIDENCE,
			IProjectVariables.WHAT_IS_FIELD_INPUTMODE,
			IProjectVariables.WHAT_IS_FIELD_INTERPRETATION,
			IProjectVariables.WHAT_IS_FIELD_NOINPUTCOUNT,
			IProjectVariables.WHAT_IS_FIELD_NOMATCHCOUNT,
			IProjectVariables.WHAT_IS_FIELD_UTTERANCE,
			IProjectVariables.WHAT_IS_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.WHAT_IS, variableFields, null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.MOD_NUM, "0", null, session, false, false );
		session.putVariable(variable);
	...
	/**
	 * This method returns a list of initializer classes for Pluggable Connectors.
	 * Last generated by Dialog Designer at: 2008-JUL-01  02:39:22 PM
	 */
	public java.util.Collection getPluggableInitializers() {
