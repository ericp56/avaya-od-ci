...
public class Welcome extends com.avaya.sce.runtime.Form {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("MathQuizChoice");
		return submit;
	}
	/**
	...
	public java.util.Collection getTrackingActions(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.tracking.ReportInfo(com.avaya.sce.runtimecommon.IReportInfo.REPORT_TYPE_START_TRANS, com.avaya.sce.runtimecommon.IReportInfo.ALARM_LEVEL_INFO, "Play Prompt", "Welcome to the math quiz.", ""));
		return(list);
	}
	/**
