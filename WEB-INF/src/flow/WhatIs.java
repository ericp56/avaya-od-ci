 ...
 */
public class WhatIs extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		promptNames.add(new com.avaya.sce.runtime.PromptRefInfo("Choose", ""));

		// build the list of grammar information objects for the field
		grammarInfo = new java.util.ArrayList(2);
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("YourAnswerDTMF", "1.0"));
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("YourAnswerVoice", "1.0"));


		// build events for the field: "WhatIs"
		...
		nbest = 1;
		field = new com.avaya.sce.runtime.Field("WhatIs", false, true, grammarInfo, promptNames, events, properties, nbest, false, false, com.avaya.sce.runtimecommon.SCERT.RECTARG_BODYTEXT_GEN);
		list.add(field);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("TotalCorrectAnswers");
		return submit;
	}
	/**
